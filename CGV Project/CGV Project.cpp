...
void DirectionalShadowMapPass(DirectionalLight* light)
{
	...
	glm::mat4 lightPointer = light->CalculateLightTransform();
	directionalShadowShader.SetDirectionalLightTransform(&lightPointer);
...
void RenderPass(glm::mat4 viewMatrix, glm::mat4 projectionMatrix)
{
	...
	glm::mat4 mainLightPointer = mainLight.CalculateLightTransform();
	shaderList[0].SetDirectionalLightTransform(&mainLightPointer);
...
int main()
{
	mainWindow = Window(3840, 2160); // 1280, 1024 or 1024, 768
